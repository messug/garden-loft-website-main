      ...
      <section id="village">
        ...
        <div className="village-content">
          ...
          <p>
            ...
            10 Garden Loft units in a <br/>  park-like setting adjacent to<br/>an existing care facility<br/>  in order to increase capacity
          </p>
          <img src={Village7} alt="GL-Cost Image" />
          <h3>Country Residential Village</h3>
          <p>
           93 Garden Loft units <br/> augmented with community amenity <br/> buildings on an acreage site<br/>  outside of Calgary
          </p>
