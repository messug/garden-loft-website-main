...
import GLImage2 from  "../../assets/images/backyard 34.jpg"
...
const Costs: React.FC = () => {
  return (
    ...
    <h2>Garden Lofts  can be more <br />affordable than living in a care  <br />facility</h2>
    <button className="button-costs desktop-cost-button"><Link to="/learn-more#costs" >Compare <br /> our costs</Link></button>
      </div>
